                ...
                <div className="col-sm-9">
                    <div className="row mb-2">
                        <div className="col-sm-4">
                            <button className="btn-block btn-lg btn-default" 
                    ...
                    <div className="row mb-2">
                        ...
                        <div className="col-sm-4">
                            <button className="btn-block btn-lg btn-danger" 
                ...
                <div className="col-sm-3">
                    <div className="row mb-2">
                        <div className="col-sm-6">
                            <button className="btn-block btn-lg btn-primary" 
                            onClick={()=>{this.props.pressButton(`+`)}}>
                                +
                            </button>
                        </div>  
                    ...
                    onClick={() => {this.props.pressEqual()}}>=</button>
